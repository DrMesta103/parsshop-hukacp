            ...
            <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        ...
                        <span
                            class="text-lg ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle hidden md:inline dark:text-white-light transition-all duration-300"
                            >پنل مدیریت هوکا</span
                        >
                    </router-link>
                                        ...
                                        <li>
                                            ...
                                            >
                                                <img
                                                    ...
                                                    :src="`/assets/images/flags/${getLanguageFlag(item.code)}.svg`"
                                                    alt=""
                                                />
...
<script lang="ts" setup>
    ...
    const getLanguageFlag = (code: string) => {
        return code.toLowerCase() === 'fa' ? 'IR' : code.toUpperCase();
    };
    ...
    const currentFlag = computed(() => {
        return `/assets/images/flags/${getLanguageFlag(i18n.locale)}.svg`;
    });
