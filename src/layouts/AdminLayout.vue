<template>
  <div class="relative main-section antialiased text-sm font-normal" :class="[appStore.sidebar ? 'toggle-sidebar' : '', appStore.menu, appStore.layout, appStore.rtlClass]">
    ...
    <!-- Main container - same structure as demo -->
    <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[appStore.navbar]">
      <Sidebar />
      <div class="main-content flex min-h-screen flex-col">
        <Header />
        <div class="animation p-4 sm:p-6">
          <router-view />
        </div>
        <Footer />
      </div>
